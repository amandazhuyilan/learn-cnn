...
The following README content is extracted from [assignment1.md](https://github.com/cs231n/cs231n.github.io/edit/master/assignments/2017/assignment1.md).
...
**Virtual environment:**
[Virtual environment](http://docs.python-guide.org/en/latest/dev/virtualenvs/) is recommended for the project. If you choose not to use a virtual environment, it is up to you to make sure that all dependencies for the code are installed globally on your machine. To set up a virtual environment, run the following:
